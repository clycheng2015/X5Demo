...
public class X5CookieManagerModule extends ReactContextBaseJavaModule {
    ...
    private X5ForwardingCookieHandler mCookieHandler;

    public X5CookieManagerModule(ReactApplicationContext context) {
        super(context);
        mCookieHandler = new X5ForwardingCookieHandler(context);
    }

    public String getName() {
        return "X5RNCookieManager";
    }
